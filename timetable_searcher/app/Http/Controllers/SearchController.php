...
// バス停の新規登録画面
const SUBMITPAGE = 'https://hogehoge.com/submit/';

class SearchController extends Controller
{
    public function index() {
        //Cookieが空で$_POSTに入力があったらsetcookieする
        if ( $_COOKIE == null ) {
            header( 'Location: ' . SUBMITPAGE );
        }
        //Cookie[dept]から先頭のバス停名を取り出して出発地バス停とする
        //Cookie[dest]から先頭のバス停名を取り出して目的地バス停とする
        //Cookie[num]から表示する時刻の数を得る
    }
    ...
    public function search( $deptpoll_name, $destpoll_name, $num_of_times ) {
